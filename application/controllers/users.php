...
class Users extends CI_Controller {
    ...
    public function register() {
        ...
        $this->form_validation->set_message('in_list', '"Registration key" is incorrect.');
        ...
        $this->form_validation->set_rules('registration_key', '"Registration key"', 'trim|required|in_list[secret_key]');
