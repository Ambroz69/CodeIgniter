...
<div class='col-xs-3 container-fluid bg-info img-rounded' style="border:3px groove cornflowerblue">
    <ul class='btn-group'>
        ...
        <td><a href='<?php echo base_url();?>shift_details/delete_shift_details/<?php echo $shift_details_data->ID; ?>' class='btn btn-sm btn-block btn-danger' role='button'>Delete shift detail </a></td>
    </ul>
</div>
